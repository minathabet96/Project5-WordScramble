...
//
//  Created by Mina Thabet on 24/08/2023.
//
   ...
   @objc func startGame(){
    ...
    func submit(_ answer: String){
        ...
        if isPossible(word: lowerAnswer) {
            ...
            showErrorMessage(errorTitle:"Word too short", errorMessage:"Enter at least a 3 letter word")
            }
            else if answer == title! {
            showErrorMessage(errorTitle:"Impossible", errorMessage:"You can't just do that!")
            }
            else {
            ...
            showErrorMessage(errorTitle: "Word already used", errorMessage: "Be more creative!")
            }
        }
        else {
